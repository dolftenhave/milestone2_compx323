...
INSERT INTO m2s_SpeciesGroup VALUES ('Unknown', 'Unknown');
...
INSERT INTO M2S_ANIMAL (aid, sex, feedingInterval, name, weight, originCountry, dob, enclosureID, speciesName)
VALUES (1, 'M', 24, 'Leo', 210000, 'TZA', TO_DATE('2017-04-11', 'YYYY-MM-DD'), 1, 'Panthera leo');

INSERT INTO M2S_ANIMAL (aid, sex, feedingInterval, name, weight, originCountry, dob, enclosureID, speciesName)
VALUES (2, 'F', 24, 'Tama', 2000, 'NZL', TO_DATE('2015-03-03', 'YYYY-MM-DD'), 2, 'Apteryx haastii');

INSERT INTO M2S_ANIMAL (aid, sex, feedingInterval, name, weight, originCountry, dob, enclosureID, speciesName)
VALUES (3, 'M', 24, 'Skippy', 18000, 'AUS', TO_DATE('2018-08-20', 'YYYY-MM-DD'), 3, 'Macropus giganteus');
